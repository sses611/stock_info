...
function GetStoreList() {
    ...
    //금융위원회_주식배당정보
    flag = (LoadData("http://apis.data.go.kr/1160100/service/GetStocDiviInfoService/getDiviInfo?pageNo=1&numOfRows=1&resultType=json&stckIssuCmpyNm=삼성전자&serviceKey=" + serviceKeyStr, 0))
    alert(flag)

    // flag = (LoadData("http://apis.data.go.kr/1160100/service/GetStocDiviInfoService/getDiviInfo?&stckIssuCmpyNm=삼성전자&serviceKey=" + serviceKeyStr, 0))
